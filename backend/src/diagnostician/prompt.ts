...
5. Confidence must reflect the actual strength of the evidence. Do not inflate it. A confidence above 85 asserts you would be comfortable with a human terminating this workload on your reasoning alone.
...
export const VERDICT_SCHEMA = {
  ...
  properties: {
    ...
    confidence: {
      ...
      maximum: 100,
      description:
        "Calibrated confidence in the verdict as a whole percent, 0 to 100. " +
        "Write digits only, e.g. 92.",
    },
    incident_type: {
      type: "string",
